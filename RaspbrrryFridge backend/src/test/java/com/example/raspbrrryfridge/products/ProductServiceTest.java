...
class ProductServiceTest {
    ...
    @Test
    void addProduct() {
        ProductDto productToAdd = new ProductDto("Test Product", 100);
    ...
    void deleteProduct() {
        ...
        ProductDto productToDelete = new ProductDto("Test Product", 100);
    ...
    void findProductById() {
        ...
        ProductDto productToFind = new ProductDto("Test Product", 100);
